...
public class AuthController {
  ...
  public ResponseEntity<TokenResponse> signIn(@RequestBody SignInRequest dto) {
    ...
    return ResponseEntity.ok()
        ...
        .body(new TokenResponse(tokens.getAccessToken(), "", tokens.getEmail(), tokens.getNickname())); // 바디에는 accessToken
  }
  ...
  public ResponseEntity<TokenResponse> reissue(
    ...
    return ResponseEntity.ok()
        .header(HttpHeaders.SET_COOKIE, cookie.toString())
        .body(new TokenResponse(tokens.getAccessToken(), null, tokens.getEmail(), tokens.getNickname()));
  }
